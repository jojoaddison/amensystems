        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.homeService.find(id).subscribe((home) => {
                    home.createdDate = this.datePipe
                        .transform(home.createdDate, 'yyyy-MM-ddTHH:mm:ss');
                    home.modifiedDate = this.datePipe
                        .transform(home.modifiedDate, 'yyyy-MM-ddTHH:mm:ss');
